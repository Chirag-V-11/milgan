      ...
      <section className="py-24 md:py-40 px-6 mx-auto relative z-10 bg-[#FCFCFC]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
          <div className="relative aspect-square md:aspect-[4/5] rounded-[3rem] overflow-hidden border border-white/30 shadow-2xl group">
             <img 
               src="https://images.unsplash.com/photo-1596484552834-6a58f850d0a1?auto=format&fit=crop&q=80&w=1000" 
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-24">
          ...
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
             ...
             <div className="break-inside-avoid relative aspect-[4/5] rounded-[2.5rem] overflow-hidden group border border-white/20 shadow-xl">
                <img src="https://images.unsplash.com/photo-1543163521-1bf539c55dd2?auto=format&fit=crop&q=80&w=1000" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" alt="Customer" />
